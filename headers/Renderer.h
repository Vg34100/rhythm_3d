...
public:
	...
	s_ptr<Framebuffer> gbuffer, input, output;

	s_ptr<Framebuffer> shadowMap;
	bool useShadow = true;

	s_ptr<Framebuffer> dummyInput;
	...
	double renderScene(const mat4& projection, const mat4& view, s_ptr<Framebuffer> framebuffer = nullptr);
