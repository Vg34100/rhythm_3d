...
bundle:
	tar --exclude ".vs" -czvf 4480-bundle.tgz bin/ shaders/

bigbundle:
	tar --exclude ".vs" -czvf 4480-bigbundle.tgz bin/ headers/ include/ lib/ Makefile obj/ shaders/ src/ textures/ winbuild/

wildbundle:
	tar --exclude ".vs" --exclude "winbuild/x64" --exclude "Makefile" -czvf 4480-wildbundle.tgz ./*

wildzip:
	zip -r 4480-bundle.zip ./ -x ".git*" "*.tgz" "*.zip" "bin*" "obj*" "winbuild/.vs*" "winbuild/x64*" "winbuild/codebase/*" "winbuild/.git*" "Makefile"
